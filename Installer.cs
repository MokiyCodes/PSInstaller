...
");
  ...
  private static bool Elevate()
  {
    if (IsAdministrator() == false)
    {
      ...
      startInfo.Arguments = "rra " + String.Join(" ",args).ToLower();
  ...
  public static void Run()
  {
    ...
    if (Elevate())
    {
      ...
      Log("Downloading PSTools from "+PSURL, "Downloading PSTools");
...
#pragma warning restore SYSLIB0014 // Type or member is obsolete
      ...
      Log("Extracting PSTools", "Extracting PSTools");
...
By using PSTools you agree to the Windows Sysinternals EULA. It can be found in bin/EULA.txt or at https://docs.microsoft.com/en-us/sysinternals/license-terms");

      if (!Directory.Exists(Path.Combine(InstallLocation, "bin"))) throw new Exception("Cannot find binary files in extracted archive");

      Log("Adding to PATH", "Adding to PATH");
      ...
      {
        Log("By using SysInternals, you agree to the SysInternals EULA found at https://docs.microsoft.com/en-us/sysinternals/license-terms \nBy default, Microsoft asks you to accept these every time you run any sysinternals application." + @"
